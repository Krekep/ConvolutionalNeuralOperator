from DataLoaders.CNO_TimeLoaders import (
    BrownianBridgeTimeDataset,
    VortexSheetTimeDataset,
    SinesTimeDataset,
    PiecewiseConstantsTimeDataset,
    GaussiansTimeDataset,
    ComplicatedShearLayerTimeDataset,
    KelvinHelmholtzTimeDataset,
    RiemannTimeDataset,
    RiemannCurvedTimeDataset,
    EulerGaussTimeDataset,
    RiemannKHTimeDataset,
    RichtmyerMeshkov,
    RayleighTaylor,
    PoissonGaussians,
    Helmholtz,
...
def load_dataset(
    ...
    if which == "ns_brownian":
        ...
        train_dataset = BrownianBridgeTimeDataset(
        ...
        train_dataset = GaussiansTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = SinesTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = VortexSheetTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = ComplicatedShearLayerTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = KelvinHelmholtzTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = RiemannTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = RiemannCurvedTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = EulerGaussTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = RiemannKHTimeDataset(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = RichtmyerMeshkov(
            max_num_time_steps=dic["time_steps"],
            time_step_size=dic["dt"],
            fix_input_to_time_step=fix_input_to_time_step,
            which=which_loader,
        ...
        train_dataset = PoissonGaussians(
            which=which_loader,
            resolution=128,
            in_dist=True,
            num_trajectories=num_samples,
