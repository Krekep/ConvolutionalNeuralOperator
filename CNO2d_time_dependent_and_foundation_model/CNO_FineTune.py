...
from test_and_fine_tune_utils.fine_tune_utils import (
    load_model,
    allowed_transitions,
    initialize_emb,
)
...
if __name__ == "__main__":
    ...
    sufix = "traj" + str(num_trajectories) + "_" + "lr_" + str(
        properties["lr"]
    ) + "_" + str(properties["lr_emb"]) + "_" + str(
        properties["lr_norm"]
    ) + "_" "epoch" + str(
        epochs
    )
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=folder_model + "/model" + str(ver), monitor="mean_val_l"
    )
